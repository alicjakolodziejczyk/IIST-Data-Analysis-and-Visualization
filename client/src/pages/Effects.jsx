...
function Effects() {
  ...
  <div style={{height: '25px', width: '25px', backgroundColor: '#f694c1', display: 'inline-block', margin: '10px'}}></div>
  <span style={{marginRight: '50px'}}> - zdobyta część efektu</span>
  <div style={{height: '25px', width: '25px', backgroundColor: '#e4c1f9', display: 'inline-block', margin: '10px'}}></div>
  <span style={{marginRight: '50px'}}>- zdobywana część efektu w tym semestrze</span>
  <div style={{height: '25px', width: '25px', backgroundColor: '#a9def9', display: 'inline-block', margin: '10px'}}></div>
